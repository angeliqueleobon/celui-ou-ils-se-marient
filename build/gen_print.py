...
recto.append(T(X, 632, 'title', 'CEUX QUI SE MARIENT', 'THE ONE WITH THE WEDDING', TOMATO))
...
def text_block(fill_ink, fill_green, fill_tomato, amp):
    ...
    out.append(T(X, 632, 'title', 'CEUX QUI SE MARIENT', 'THE ONE WITH THE WEDDING', fill_tomato))
...
fleur.append(T(CX, 596, 'title', 'CEUX QUI SE MARIENT', 'THE ONE WITH THE WEDDING', TOMATO, anchor='middle'))
...
grosdate.append(T(X, 386, 'title-s', 'CEUX QUI SE MARIENT', 'THE ONE WITH THE WEDDING', TOMATO))
...
horizon.append(T(X, 570, 'title', 'CEUX QUI SE MARIENT', 'THE ONE WITH THE WEDDING', TOMATO))
...
typo.append(T(X, 660, 'title', 'CEUX QUI SE MARIENT', 'THE ONE WITH THE WEDDING', TOMATO))
